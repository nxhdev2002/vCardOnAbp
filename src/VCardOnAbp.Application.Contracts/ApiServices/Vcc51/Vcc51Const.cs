...
public class Vcc51Const
{
    ...
    public static readonly Uri CREATEEDIT_URL = new Uri("https://www.51vcc.com/websystem/jcsj/Kaoci_AddEdit.aspx?id=0");
    public static readonly Uri CLIENT_URL = new Uri("https://www.51vcc.com/websystem/jcsj/Kaoci_Manage.aspx");
